                ...
                <div class="col-md-9 post-content" data-aos="fade-up">
                        ...
                        <!-- ======= Single Post Content ======= -->
                            ...
                            <div class="single-post">
                                ...
                                <p><span class="firstcharacter">{{ substr($post->content, 0, 1) }}</span>{{ substr($post->content, 1) }}</p>
                        
                                <figure class="my-4">
                                    <img src="{{ $post->img_cover }}" alt="" class="img-fluid">
                    ...
                    <div class="comments">
                        ...
                        <div class="comment d-flex mb-4">
                            <div class="flex-shrink-0">
                                <div class="avatar avatar-sm rounded-circle">
                                    <img class="avatar-img" src="/client/assets/img/person-5.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-2 ms-sm-3">
                                ...
                                <div class="comment-replies bg-light p-3 mt-3 rounded">
                                    ...
                                    <div class="reply d-flex mb-4">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img" src="/client/assets/img/person-4.jpg" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                                    ...
                                    <div class="reply d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm rounded-circle">
                                                <img class="avatar-img" src="/client/assets/img/person-3.jpg" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-2 ms-sm-3">
                        ...
                        <div class="comment d-flex">
                            <div class="flex-shrink-0">
                                <div class="avatar avatar-sm rounded-circle">
                                    <img class="avatar-img" src="/clientassets/img/person-2.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="aside-block">
                        ...
                        <div class="video-post">
                            <a href="/client/https://www.youtube.com/watch?v=AiFfDjmd0jU" class="glightbox link-video">
                                <span class="bi-play-fill"></span>
                                <img src="/client/assets/img/post-landscape-5.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Video -->
